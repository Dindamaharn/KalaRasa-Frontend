      ...
      <div className="admin-update-page">
        ...
        <div className="admin-update-content">
          <div className="admin-update-layout">
            {/* BACK */}
            <button className="admin-update-back-btn" onClick={() => navigate(-1)}>
            ...
            <div className="admin-update-card">
              ...
              >
                ...
                <span className="admin-update-change-photo">Tekan untuk memilih ulang foto</span>
                <input
                  type="file"
                  ref={fileInputRef}
              ...
              <div className="admin-update-row-3">
                <div>
                  ...
                  <input type="number" value={waktuMasak} onChange={(e) => setWaktuMasak(e.target.value)} />
                </div>
              ...
              {ingredients.map((item, index) => (
                <div className="admin-update-ingredient-row" key={index}>
                  ...
                  <input value={item.amount} onChange={(e) => updateIngredient(index, "amount", e.target.value)} />
                  <input value={item.unit} onChange={(e) => updateIngredient(index, "unit", e.target.value)} />
                </div>
              ))}
              ...
              {steps.map((step, index) => (
                <div className="admin-update-step-row" key={index}>
                  <span className="admin-update-step-number">{index + 1}.</span>
              ...
              <div className="admin-update-buttons">
                <button className="admin-update-cancel" onClick={() => navigate(-1)}>
                  Batal
                </button>
                <button className="admin-update-submit" onClick={handleUpdate}>
                  Simpan Pembaharuan
                </button>
              </div>
            </div>
